...
// Shared seam, copy of MoviesLeechProvider/LinkResolver.kt (only the
// MoviesLeechParser.* references were retargeted to MoviesModParser).
...
class LinkResolver(
    ...
    suspend fun resolveShortLink(shortUrl: String, name: String, qualityLabel: String): List<ResolvedLink> {
        ...
        val fileLink = redirect?.let { MoviesModParser.resolveUrl(res.url, it) } ?: ""
